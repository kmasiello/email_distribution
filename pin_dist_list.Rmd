...
```{r}
distribution <- data.frame(Name = c("Katie", "Elena", "Josiah", "Colin", "Brian", "Nichole", "Ryan", "Shannon"), Email = c("katie.masiello@rstudio.com", "elena@rstudio.com", "josiah@rstudio.com", "colin@rstudio.com", "brian.law@rstudio.com", "nichole@rstudio.com", "ryan@rstudio.com", "shannon@rstudio.com"))
